...
use cosmwasm_std::{Addr, Coin, Decimal256, Deps, Env, StdResult, Uint128};
...
pub fn query_rewards(
    ...
    match deposits {
        Some(_) => Ok(INCENTIVE_SCHEDULES.prefix(&lp_token)
        .range(deps.storage, None, None, cosmwasm_std::Order::Ascending)
        .map(|item: Result<(String, astroport::incentives::IncentivesSchedule), cosmwasm_std::StdError>| {
            ...
            let amount = schedule.rps.checked_mul(Decimal256::from_str("5000").unwrap()).unwrap();
            Coin {
