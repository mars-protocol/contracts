...
use mars_outpost::red_bank::{Market, User};
...
fn test_borrow_and_repay() {
    ...
    // should get index 0
    let market_1_initial = th::init_market(deps.as_mut(), "uosmo", &mock_market_1);
    // should get index 1
    let market_2_initial = th::init_market(deps.as_mut(), "uusd", &mock_market_2);
    // should get index 2
    let market_collateral = th::init_market(deps.as_mut(), "uatom", &mock_market_3);
    ...
    let expected_params_uosmo = th::get_expected_indices_and_rates(
        &market_1_initial,
        block_time,
    ...
    assert_eq!(
        ...
        vec![
            ...
            th::build_interests_updated_event("uosmo", &expected_params_uosmo)
        ]
    );
    ...
    let expected_params_uusd = th::get_expected_indices_and_rates(
        &market_2_initial,
        block_time,
    ...
    assert_eq!(
        ...
        vec![
            ...
            th::build_interests_updated_event("uusd", &expected_params_uusd)
        ]
    );
    ...
    assert_eq!(res.events, vec![th::build_interests_updated_event("uusd", &expected_params_uusd)]);
...
fn test_cannot_repay_if_market_inactive() {
    ...
    let _market = th::init_market(deps.as_mut(), "somecoin", &mock_market);
...
fn test_repay_on_behalf_of() {
    ...
    let mut deps = th::setup(&[coin(available_liquidity_native.into(), "borrowedcoinnative")]);
    ...
    let market_1_initial = th::init_market(deps.as_mut(), "depositedcoinnative", &mock_market_1); // collateral
    let market_2_initial = th::init_market(deps.as_mut(), "borrowedcoinnative", &mock_market_2);
...
fn test_borrow_uusd() {
    ...
    let mut deps = th::setup(&[coin(initial_liquidity, "uusd")]);
    let block_time = 1;
    ...
    let market = th::init_market(deps.as_mut(), "uusd", &mock_market);
...
fn test_borrow_collateral_check() {
    ...
    // should get index 0
    let market_1_initial = th::init_market(deps.as_mut(), "uatom", &mock_market_1);
    // should get index 1
    let market_2_initial = th::init_market(deps.as_mut(), "uosmo", &mock_market_2);
    // should get index 2
    let market_3_initial = th::init_market(deps.as_mut(), "uusd", &mock_market_3);
...
fn test_cannot_borrow_if_market_not_active() {
    ...
    th::init_market(deps.as_mut(), "somecoin", &mock_market);
