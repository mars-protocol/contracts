...
export const marsAddressProviderQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...marsAddressProviderQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...marsAddressProviderQueryKeys.address(contractAddress)[0],
    method: "config",
    args
  }] as const),
  address: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...marsAddressProviderQueryKeys.address(contractAddress)[0],
    method: "address",
    args
  }] as const),
  addresses: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...marsAddressProviderQueryKeys.address(contractAddress)[0],
    method: "addresses",
    args
  }] as const),
  allAddresses: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...marsAddressProviderQueryKeys.address(contractAddress)[0],
...
export function useMarsAddressProviderAllAddressesQuery<TData = ArrayOfAddressResponseItem>({
  ...
  return useQuery<ArrayOfAddressResponseItem, Error, TData>(marsAddressProviderQueryKeys.allAddresses(client?.contractAddress, args), () => client ? client.allAddresses({
    limit: args.limit,
...
export function useMarsAddressProviderAddressesQuery<TData = ArrayOfAddressResponseItem>({
  ...
  return useQuery<ArrayOfAddressResponseItem, Error, TData>(marsAddressProviderQueryKeys.addresses(client?.contractAddress), () => client ? client.addresses() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useMarsAddressProviderAddressQuery<TData = AddressResponseItem>({
  ...
  return useQuery<AddressResponseItem, Error, TData>(marsAddressProviderQueryKeys.address(client?.contractAddress), () => client ? client.address() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useMarsAddressProviderConfigQuery<TData = InstantiateMsg>({
  ...
  return useQuery<InstantiateMsg, Error, TData>(marsAddressProviderQueryKeys.config(client?.contractAddress), () => client ? client.config() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useMarsAddressProviderTransferOwnershipMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsAddressProviderTransferOwnershipMutation>, "mutationFn">) {
  ...
  }) => client.transferOwnership(msg, fee, memo, funds), options);
}
...
export function useMarsAddressProviderSetAddressMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsAddressProviderSetAddressMutation>, "mutationFn">) {
  ...
  }) => client.setAddress(msg, fee, memo, funds), options);
}