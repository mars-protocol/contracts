...
export interface CreditManagerReadOnlyInterface {
  ...
  positions: ({ tokenId }: { tokenId: string }) => Promise<PositionsWithValueResponse>
  health: ({ tokenId }: { tokenId: string }) => Promise<HealthResponse>
  allCoinBalances: ({
    limit,
    startAfter,
  }: {
...
export class CreditManagerQueryClient implements CreditManagerReadOnlyInterface {
  ...
  positions = async ({ tokenId }: { tokenId: string }): Promise<PositionsWithValueResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      positions: {
        token_id: tokenId,
      },
  ...
  health = async ({ tokenId }: { tokenId: string }): Promise<HealthResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      health: {
        token_id: tokenId,
      },
