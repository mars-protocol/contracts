...
export interface MarsMockRedBankMigrateMutation {
...
export function useMarsMockRedBankMigrateMutation(
  options?: Omit<
    UseMutationOptions<ExecuteResult, Error, MarsMockRedBankMigrateMutation>,
    'mutationFn'
  >,
) {
  return useMutation<ExecuteResult, Error, MarsMockRedBankMigrateMutation>(
