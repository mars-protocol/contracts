...
export interface MarsVaultReadOnlyInterface {
...
export interface MarsVaultInterface extends MarsVaultReadOnlyInterface {
  contractAddress: string
  sender: string
  deposit: (
    {
...
export class MarsVaultClient extends MarsVaultQueryClient implements MarsVaultInterface {
