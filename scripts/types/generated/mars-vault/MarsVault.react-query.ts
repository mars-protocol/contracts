...
export const marsVaultQueryKeys = {
  ...
  address: (contractAddress: string | undefined) =>
    [{ ...marsVaultQueryKeys.contract[0], address: contractAddress }] as const,
  vaultStandardInfo: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsVaultQueryKeys.address(contractAddress)[0], method: 'vault_standard_info', args },
    ] as const,
  info: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...marsVaultQueryKeys.address(contractAddress)[0], method: 'info', args }] as const,
  previewDeposit: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsVaultQueryKeys.address(contractAddress)[0], method: 'preview_deposit', args },
    ] as const,
  previewRedeem: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsVaultQueryKeys.address(contractAddress)[0], method: 'preview_redeem', args },
    ] as const,
  totalAssets: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [{ ...marsVaultQueryKeys.address(contractAddress)[0], method: 'total_assets', args }] as const,
  ...
  convertToShares: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsVaultQueryKeys.address(contractAddress)[0], method: 'convert_to_shares', args },
    ] as const,
  convertToAssets: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsVaultQueryKeys.address(contractAddress)[0], method: 'convert_to_assets', args },
    ] as const,
  vaultExtension: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsVaultQueryKeys.address(contractAddress)[0], method: 'vault_extension', args },
    ] as const,
}
