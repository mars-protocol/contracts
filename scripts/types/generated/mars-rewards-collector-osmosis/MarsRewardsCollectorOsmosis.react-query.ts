...
export function useMarsRewardsCollectorOsmosisExecuteCosmosMsgMutation(
  options?: Omit<
    UseMutationOptions<ExecuteResult, Error, MarsRewardsCollectorOsmosisExecuteCosmosMsgMutation>,
    'mutationFn'
  >,
) {
