...
export const marsRewardsCollectorOsmosisQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...marsRewardsCollectorOsmosisQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...marsRewardsCollectorOsmosisQueryKeys.address(contractAddress)[0],
    method: "config",
    args
  }] as const),
  route: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...marsRewardsCollectorOsmosisQueryKeys.address(contractAddress)[0],
    method: "route",
    args
  }] as const),
  routes: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...marsRewardsCollectorOsmosisQueryKeys.address(contractAddress)[0],
    method: "routes",
    args
  }] as const)
};
...
export function useMarsRewardsCollectorOsmosisRoutesQuery<TData = ArrayOfRouteResponseForString>({
  ...
  return useQuery<ArrayOfRouteResponseForString, Error, TData>(marsRewardsCollectorOsmosisQueryKeys.routes(client?.contractAddress, args), () => client ? client.routes({
    limit: args.limit,
...
export function useMarsRewardsCollectorOsmosisRouteQuery<TData = RouteResponseForString>({
  ...
  return useQuery<RouteResponseForString, Error, TData>(marsRewardsCollectorOsmosisQueryKeys.route(client?.contractAddress, args), () => client ? client.route({
...
export function useMarsRewardsCollectorOsmosisConfigQuery<TData = ConfigForString>({
  ...
  return useQuery<ConfigForString, Error, TData>(marsRewardsCollectorOsmosisQueryKeys.config(client?.contractAddress), () => client ? client.config() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useMarsRewardsCollectorOsmosisExecuteCosmosMsgMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsRewardsCollectorOsmosisExecuteCosmosMsgMutation>, "mutationFn">) {
  return useMutation<ExecuteResult, Error, MarsRewardsCollectorOsmosisExecuteCosmosMsgMutation>(({
    client,
    msg,
    args: {
      fee,
  ...
  }) => client.executeCosmosMsg(msg, fee, memo, funds), options);
}
...
export function useMarsRewardsCollectorOsmosisSwapAssetMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsRewardsCollectorOsmosisSwapAssetMutation>, "mutationFn">) {
  ...
  }) => client.swapAsset(msg, fee, memo, funds), options);
}
...
export function useMarsRewardsCollectorOsmosisDistributeRewardsMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsRewardsCollectorOsmosisDistributeRewardsMutation>, "mutationFn">) {
...
export function useMarsRewardsCollectorOsmosisWithdrawFromRedBankMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsRewardsCollectorOsmosisWithdrawFromRedBankMutation>, "mutationFn">) {
  ...
  }) => client.withdrawFromRedBank(msg, fee, memo, funds), options);
}
...
export function useMarsRewardsCollectorOsmosisSetRouteMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsRewardsCollectorOsmosisSetRouteMutation>, "mutationFn">) {
  ...
  }) => client.setRoute(msg, fee, memo, funds), options);
}
...
export function useMarsRewardsCollectorOsmosisUpdateConfigMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, MarsRewardsCollectorOsmosisUpdateConfigMutation>, "mutationFn">) {
