...
import {
  ...
  PaginationResponseForUserDebtResponse,
  UserHealthStatus,
...
export const marsRedBankQueryKeys = {
  ...
  userDebtV2: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsRedBankQueryKeys.address(contractAddress)[0], method: 'user_debt_v2', args },
    ] as const,
  ...
  userDebtsV2: (contractAddress: string | undefined, args?: Record<string, unknown>) =>
    [
      { ...marsRedBankQueryKeys.address(contractAddress)[0], method: 'user_debts_v2', args },
    ] as const,
...
export interface MarsRedBankUserDebtsV2Query<TData>
  extends MarsRedBankReactQuery<PaginationResponseForUserDebtResponse, TData> {
  args: {
    accountId?: string
    limit?: number
    startAfter?: string
...
export function useMarsRedBankUserDebtsV2Query<TData = PaginationResponseForUserDebtResponse>({
  client,
  args,
  options,
}: MarsRedBankUserDebtsV2Query<TData>) {
  return useQuery<PaginationResponseForUserDebtResponse, Error, TData>(
    marsRedBankQueryKeys.userDebtsV2(client?.contractAddress, args),
    () =>
      client
        ? client.userDebtsV2({
            accountId: args.accountId,
...
export interface MarsRedBankUserDebtV2Query<TData>
...
export function useMarsRedBankUserDebtV2Query<TData = UserDebtResponse>({
  client,
  args,
  options,
}: MarsRedBankUserDebtV2Query<TData>) {
  return useQuery<UserDebtResponse, Error, TData>(
    marsRedBankQueryKeys.userDebtV2(client?.contractAddress, args),
    () =>
      client
        ? client.userDebtV2({
            accountId: args.accountId,
...
export interface MarsRedBankRepayV2Mutation {
  client: MarsRedBankClient
  msg: {
    accountId?: string
    onBehalfOf?: string
...
export function useMarsRedBankRepayV2Mutation(
  options?: Omit<
    UseMutationOptions<ExecuteResult, Error, MarsRedBankRepayV2Mutation>,
    'mutationFn'
  >,
) {
  return useMutation<ExecuteResult, Error, MarsRedBankRepayV2Mutation>(
    ({ client, msg, args: { fee, memo, funds } = {} }) => client.repayV2(msg, fee, memo, funds),
    options,
  )
}
...
export interface MarsRedBankBorrowV2Mutation {
  client: MarsRedBankClient
  msg: {
    accountId?: string
    amount: Uint128
...
export function useMarsRedBankBorrowV2Mutation(
  options?: Omit<
    UseMutationOptions<ExecuteResult, Error, MarsRedBankBorrowV2Mutation>,
    'mutationFn'
  >,
) {
  return useMutation<ExecuteResult, Error, MarsRedBankBorrowV2Mutation>(
    ({ client, msg, args: { fee, memo, funds } = {} }) => client.borrowV2(msg, fee, memo, funds),
    options,
  )
}
