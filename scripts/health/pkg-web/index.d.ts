...
* @returns {string}
*/
export function max_swap_estimate_js(c: HealthComputer, from_denom: string, to_denom: string, kind: SwapKind, slippage: Slippage): string;
/**
* @param {HealthComputer} c
* @param {string} denom
...
export interface InitOutput {
  ...
  readonly max_swap_estimate_js: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
