...
import { LCDClient, LegacyAminoMultisigPublicKey, LocalTerra, SimplePublicKey, Wallet } from '@terra-money/terra.js';
...
const TOKEN_DESCRIPTION =
  'Mars is a fully automated, on-chain credit protocol built on Terra ' +
