...
import { Asset, borrowNative, depositNative, setAssetOraclePriceSource } from './test_helpers.js';
...
async function queryBorrowRate(terra: LCDClient, redBank: string, asset: Asset) {
