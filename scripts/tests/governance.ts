...
(async () => {
  ...
  const oracle = await deployContract(terra, deployer, '../artifacts/mars_oracle.wasm', { owner: council });
  ...
  await executeContract(
    ...
    deployer,
    council,
    { end_proposal: { proposal_id: aliceProposalId } },
    { logger: logger },
  );
  ...
  await executeContract(
    ...
    deployer,
    council,
    { execute_proposal: { proposal_id: aliceProposalId } },
    { logger: logger },
  );
