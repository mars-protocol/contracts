...
(async () => {
  ...
  const userPositionT1 = await queryContract(terra, redBank, { user_position: { user_address: user.key.accAddress } });
  ...
  const userPositionT2 = await queryContract(terra, redBank, { user_position: { user_address: user.key.accAddress } });
  ...
  const userPositionT3 = await queryContract(terra, redBank, { user_position: { user_address: user.key.accAddress } });
  ...
  const userPositionT4 = await queryContract(terra, redBank, { user_position: { user_address: user.key.accAddress } });
