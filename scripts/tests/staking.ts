import { LCDClient, LocalTerra, MnemonicKey, MsgSend } from '@terra-money/terra.js';
...
(async () => {
...

  {
    ...
    await assert.rejects(executeContract(terra, bob, staking, { claim: {} }, { logger: logger }), (error: any) => {
