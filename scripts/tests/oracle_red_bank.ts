...
(async () => {
...

  {
    ...
    const userPosition = await queryContract(terra, redBank, { user_position: { user_address: alice.key.accAddress } });
...

  {
    ...
    const userPosition = await queryContract(terra, redBank, { user_position: { user_address: bob.key.accAddress } });
...

  {
    ...
    const userPosition = await queryContract(terra, redBank, { user_position: { user_address: carol.key.accAddress } });
...

  {
    ...
    const userPosition = await queryContract(terra, redBank, { user_position: { user_address: dan.key.accAddress } });
