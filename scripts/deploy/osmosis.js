...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (!network.addressProviderContractAddress) {
      ...
      const { contractAddress: addressProviderContractAddress } = yield client.instantiate(
        deployerAddress,
    ...
    if (!network.redBankContractAddress) {
      ...
      const { contractAddress: redBankContractAddress } = yield client.instantiate(
        deployerAddress,
    ...
    if (!network.incentivesContractAddress) {
      ...
      const { contractAddress: incentivesContractAddress } = yield client.instantiate(
        deployerAddress,
    ...
    if (!network.oracleContractAddress) {
      ...
      const { contractAddress: oracleContractAddress } = yield client.instantiate(
        deployerAddress,
    ...
    if (!network.protocolRewardsCollectorContractAddress) {
      ...
      const { contractAddress: protocolRewardsCollectorContractAddress } = yield client.instantiate(
        deployerAddress,
    ...
    console.log(
      ...
      yield client.queryContractSmart(network.addressProviderContractAddress, { config: {} }),
    );
    /*********************************************************************************************************** */
    /*********************************************************************************************************** */
    ...
    console.log(
      ...
      yield client.queryContractSmart(network.redBankContractAddress, { config: {} }),
    );
    console.log(
      `${chain_id} :: Red Bank markets list : `,
      yield client.queryContractSmart(network.redBankContractAddress, { markets: {} }),
    );
    console.log(
      `${chain_id} :: Red Bank uosmo market config : `,
      yield client.queryContractSmart(network.redBankContractAddress, { market: { denom: OSMOSIS_DENOM } }),
    );
    /*********************************************************************************************************** */
    /*********************************************************************************************************** */
    // STEP EXECUTE INITIALISE RED BANK ASSET
    ...
    console.log(
      ...
      yield client.queryContractSmart(network.redBankContractAddress, {
    ...
    console.log(
      `${chain_id} :: uosmo oracle price :  ${yield client.queryContractSmart(network.oracleContractAddress, msg)}`,
    );
    /*********************************************************************************************************** */
    /*********************************************************************************************************** */
    ...
    console.log(
      `${chain_id} :: uatom oracle price :  ${yield client.queryContractSmart(network.oracleContractAddress, msg)}`,
    );
