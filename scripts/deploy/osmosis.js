...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (Number(accountBalance.amount) < 1000000 && chain_id === 'osmo-test-4') {
        ...
        console.log(`${chain_id} :: Red Bank config : `, yield client.queryContractSmart(network.redBankContractAddress, { config: {} }));
        console.log(`${chain_id} :: Red Bank markets list : `, yield client.queryContractSmart(network.redBankContractAddress, { markets: {} }));
        console.log(`${chain_id} :: Red Bank uosmo market config : `, yield client.queryContractSmart(network.redBankContractAddress, { market: { denom: OSMOSIS_DENOM } }));
        /*********************************************************************************************************** */
        /*********************************************************************************************************** */
        // STEP EXECUTE INITIALISE RED BANK ASSET
        /*********************************************************************************************************** */
