...
async function main() {
  ...
  if (NETWORK_TO_DEPLOY_TO === 'localosmosis') {
    ...
    deployer_wallet_mnemonic = 'notice oak worry limit wrap speak medal online prefer cluster roof addict wrist behave treat actual wasp year salad speed social layer crew genius'
...
/*********************************************************************************************************** */
  ...
  const protocolRewardsCollectorWasm = fs.readFileSync(ARTIFACTS_PATH + "mars_protocol_rewards_collector.wasm");
...
/*********************************************************************************************************** */
  ...
  if (!network.incentivesContractAddress) {
    ...
    msg = {"owner":deployerAddress, "address_provider_address": network.addressProviderContractAddress, mars_denom: MARS_DENOM};
...
/*********************************************************************************************************** */
  ...
  console.log(`${chain_id} :: Address Provider config : `, await client.queryContractSmart(network.addressProviderContractAddress, {"config": {}}));
...
console.log(`${chain_id} :: Red Bank config : `, await client.queryContractSmart(network.redBankContractAddress, {"config":{}}));
console.log(`${chain_id} :: Red Bank markets list : `, await client.queryContractSmart(network.redBankContractAddress, {"markets":{}}));
console.log(`${chain_id} :: Red Bank uatom market config : `, await client.queryContractSmart(network.redBankContractAddress, {"market":{ "denom": "ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2" }}));
...
/*********************************************************************************************************** */
  ...
  if (!network.smokeTest) {
    ...
    /*********************************************************************************************************** */
    /*********************************************************************************************************** */
    // STEP EXECUTE DEPOSIT OSMO ASSET
    /*********************************************************************************************************** */
    /*********************************************************************************************************** */
    ...
    /*********************************************************************************************************** */
    /*********************************************************************************************************** */
    // STEP EXECUTE WITHDRAW OSMO ASSET
    /*********************************************************************************************************** */
    /*********************************************************************************************************** */
