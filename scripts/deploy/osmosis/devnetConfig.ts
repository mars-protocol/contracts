...
export const osmosisDevnet: DeploymentConfig = {
  ...
  oracleConfigs: [osmoOracle, atomOracle, axlOracle, wbtcOracle, axlOracle, ethOracle, usdOracle, atomOsmoOracle, usdcOsmoOracle, ethOsmoOracle, wbtcOsmoOracle, atomStAtomOracle],
