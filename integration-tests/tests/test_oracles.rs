...
use mars_oracle_base::ContractError::InvalidPriceSource;
...
use osmosis_testing::cosmrs::proto::tendermint::google::protobuf::field_descriptor_proto::Type::String;
use osmosis_testing::{Account, Gamm, Module, OsmosisTestApp, RunnerError, Wasm};
use std::str::FromStr;
...
//assert oracle was correctly set to SPOT and assert prices are queried correctly
#[test]
fn set_spot_price() {
    let app = OsmosisTestApp::new();
    let wasm = Wasm::new(&app);
