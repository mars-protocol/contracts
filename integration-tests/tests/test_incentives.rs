...
fn rewards_claim_for_credit_account() {
    ...
    assert_eq!(user_collateral.amount.u128(), funded_amt_acc_id_1 + funded_amt_acc_id_2); // credit manager total deposit amount can be queried
    ...
    assert_eq!(
        ...
        funded_amt_acc_id_1 + funded_amt_acc_id_2 - withdraw_amt_acc_id_1 - withdraw_amt_acc_id_2
    );
    let acc_id_1_collateral = red_bank.query_user_collateral_with_acc_id(
        &mut mock_env,
        &credit_manager,
